window.onload = function(){
	...
	document.getElementById('saveToImage').addEventListener('click',function(){
		downloadCanvas(this,'canvas','panel_firma.png')
	},false);

	document.getElementById('saveToImageApi').addEventListener('click',function(){
		...
		if(dni===""){
			alert("ingrese el No DNI")
		}else{
			const firmaAdd={
				identificacion:dni,
				firma: dataURL
				}
			console.log(firmaAdd)
			//const json = JSON.stringify(firmaAdd)
			//console.log(json)
	
	
			fetch ('http://159.223.191.76:4000/api/firma/',{
				method: 'POST',
				headers:{
					"content-type" : "application/json; charset=UTF-8"
	  
				},
				body: JSON.stringify(firmaAdd),
